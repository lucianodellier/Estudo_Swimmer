...
file_table = "Deltas/" + "10bodies/" + "25graus/" + "deltas.txt"
...
evolqlquantities_file = open('evolqlquantities_pandas_100steps.txt', 'a+')
steps = 100
...
for it in range(steps):              
    ...
    ##current_dtheta = (Deltas[2][current_state_dec, action] - Deltas[2][current_state_decn,action]) / 2       
...
evolqlquantities_file = open('evolqlquantities_pandas_1000steps.txt', 'a+')
steps = 1000
...
evolqlquantities_file = open('evolqlquantities_pandas_5000steps.txt', 'a+')
steps = 5000
...
evolqlquantities_file = open('evolqlquantities_pandas_10000steps.txt', 'a+')
steps = 10000
...
evolqlquantities_file = open('evolqlquantities_pandas_50000steps.txt', 'a+')
steps = 50000
...
evolqlquantities_file = open('evolqlquantities_pandas_100000steps.txt', 'a+')
steps = 100000
